  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=1:3,box1] {2*x} \closedcycle;

        \addplot [thick, domain=0:4] {2*x} node [pos=0.65,pin={130:$y = 2x$}] {};
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=-3:3,box1] {sqrt(9-x^2)} \closedcycle;

        \addplot [thick, domain=-3:3] {sqrt(9-x^2)} node [pos=0.25,pin={90:$y = \sqrt{9-x^{2}}$}] {};
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=-1:0,box1] {3*x} \closedcycle;
        \addplot+ [domain=0:2,box2] {3*x} \closedcycle;

        \addplot [thick, domain=-2:3] {3*x} node [pos=0.5,pin={130:$y = 3x$}] {};
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=1:3,box1] {2*x+1} \closedcycle;
        \addplot+ [domain=1:3,box2] {2*x} \closedcycle;

        \addplot [thick, domain=0:4] {2*x} node [pos=0.65,pin={-90:$y = 2x$}] {};
        \addplot [thick, domain=0:4] {2*x+1} node [pos=0.65,pin={150:$y = 2x+1$}] {};
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=-3:0,box1] {sqrt(9-x^2)} \closedcycle;
        \addplot+ [domain=0:3,box2] {sqrt(9-x^2)} \closedcycle;
