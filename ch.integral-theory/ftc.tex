...
Recall from \cref{thm:antiderivative.constant} that the antiderivatives of a continuous\sidefootnote{The functions we're interested in are almost always continuous, so this restriction won't cost us much.} function are all the same up to a constant.
