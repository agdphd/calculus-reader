  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=1:3] {2*x} \closedcycle;
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=-3:3] {sqrt(9-x^2)} \closedcycle;
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=-1:0] {3*x} \closedcycle;
        \addplot+ [domain=0:2] {3*x} \closedcycle;
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=1:3] {2*x+1} \closedcycle;
        \addplot+ [domain=1:3] {2*x} \closedcycle;
  ...
  \begin{marginfigure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot+ [domain=-3:0] {sqrt(9-x^2)} \closedcycle;
        \addplot+ [domain=0:3] {sqrt(9-x^2)} \closedcycle;
