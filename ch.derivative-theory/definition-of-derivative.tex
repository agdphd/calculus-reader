...
It turns out that this notion of \emph{derivative} is an extremely powerful one, so we'll spend the rest of \cref{sec:derivative-theory} fleshing out the details of the theory (including lots of tricks for calculating derivatives), then explore a variety of applications in \cref{sec:derivative-applications}.
